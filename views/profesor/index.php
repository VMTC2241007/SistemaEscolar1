                                ...
                                'buttons' => [
                                    'ver' => function ($url, $dataProvider) {
                                        return Html::button(
                                            ...
                                            [
                                                'value' => Url::to(['profesor/view', 'ID' => Util::encrypt_decryptID($dataProvider->ID, 1)]),
                            ...
                            [
                                ...
                                'buttons' => [
                                    'actualizar' => function ($url, $dataProvider) {
                                        return Html::button(
                                            '<i class="fa fa-fw fa-pen"></i></span>',
                                            [
                                                'value' => Url::to(['profesor/update', 'ID' => Util::encrypt_decryptID($dataProvider->ID, 1)]),
                                                'class' => 'btn btn-default btn-xs custom_button'
                                            ]
                                        );
                                    },
            ...
            'pjaxSettings' =>[
                ...
                'options'=>[
                  'id'=>'grid-eval',
                            ...
                            'panel' => [
                                'heading' => '<h6 style="color:white;text-align:center">Detalle de  Profesores</h6>',
                                'type' => 'primary',
                                'footer' => false,
                                'before' => false,
                            ],
